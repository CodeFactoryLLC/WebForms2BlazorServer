...
{
    public partial class PageCodeBehind : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new PageCodeBehind { CsModels = null, ModelData = null };
        ...
        {
            var factory = new PageCodeBehind { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new PageCodeBehind { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new PageCodeBehind { CsModels = null, ModelData = modelData };
