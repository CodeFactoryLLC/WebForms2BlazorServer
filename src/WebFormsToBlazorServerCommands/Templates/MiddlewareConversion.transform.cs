...
{
    public partial class MiddlewareConversion : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new MiddlewareConversion { CsModels = null, ModelData = null };
        ...
        {
            var factory = new MiddlewareConversion { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new MiddlewareConversion { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new MiddlewareConversion { CsModels = null, ModelData = modelData };
