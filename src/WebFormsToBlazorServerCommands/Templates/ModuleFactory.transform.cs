...
{
    public partial class ModuleFactory : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new ModuleFactory { CsModels = null, ModelData = null };
        ...
        {
            var factory = new ModuleFactory { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new ModuleFactory { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new ModuleFactory { CsModels = null, ModelData = modelData };
