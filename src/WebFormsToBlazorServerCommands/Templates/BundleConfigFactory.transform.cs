...
{
    public partial class BundleConfigFactory : ICsT4Factory
    {
        /// <summary>
        ...
        {
            var factory = new BundleConfigFactory { CsModels = null, ModelData = null };
        ...
        {
            var factory = new BundleConfigFactory { CsModels = modelStore, ModelData = null };
        ...
        {
            var factory = new BundleConfigFactory { CsModels = modelStore, ModelData = modelData };
        ...
        {
            var factory = new BundleConfigFactory { CsModels = null, ModelData = modelData };
